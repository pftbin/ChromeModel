...
BEGIN_MESSAGE_MAP(CCEFBrowserApp, CWinApp)
...
//	CefRefPtr<CefApp> app;								//默认CefApp
	CefRefPtr<CCEFAppHandler> app(new CCEFAppHandler); //CefApp实现，用于处理进程相关的回调
...
//====================================================================
	...
	CShadowWindow::Initialize(m_hInstance);
